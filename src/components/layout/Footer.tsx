...
export default function Footer() {
  return (
    <footer className="relative mt-14">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-56 bg-[radial-gradient(circle_at_12%_16%,rgba(239,130,57,0.12),transparent_24%),radial-gradient(circle_at_86%_10%,rgba(89,89,201,0.1),transparent_22%)]" />
