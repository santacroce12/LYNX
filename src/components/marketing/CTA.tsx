...
export default function CTA({ title, text, buttonLabel, href, className }: CTAProps) {
  return (
    <section className={cn("relative mt-10 md:mt-14", className)}>
      <div className="pointer-events-none absolute inset-x-0 top-0 h-72 bg-[radial-gradient(circle_at_14%_18%,rgba(239,130,57,0.1),transparent_24%),radial-gradient(circle_at_86%_10%,rgba(89,89,201,0.1),transparent_22%)]" />
