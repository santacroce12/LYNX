    ...
    <Reveal delay={0.2 + index * 0.06}>
      <Link
        ...
        className={`group relative block overflow-hidden rounded-[1.05rem] border p-2.5 transition duration-300 hover:-translate-y-1 md:rounded-[1.45rem] md:p-5 ${
          isEnergy
            ? "border-[rgba(247,208,163,0.16)] bg-[linear-gradient(135deg,rgba(239,130,57,0.12),rgba(13,6,37,0.94)_46%,rgba(13,6,37,0.98)_100%)] hover:border-[rgba(247,208,163,0.32)]"
            : "border-[rgba(89,89,201,0.18)] bg-[linear-gradient(135deg,rgba(89,89,201,0.14),rgba(13,6,37,0.94)_46%,rgba(13,6,37,0.98)_100%)] hover:border-[rgba(89,89,201,0.34)]"
        }`}
      >
        <div className="grid grid-cols-[76px_minmax(0,1fr)_32px] items-center gap-3 md:grid-cols-[minmax(0,1fr)_228px] md:gap-4">
              ...
              {card.highlights.map((item, chipIndex) => (
                <span
                  ...
                  className={`inline-flex items-center rounded-full border px-3 py-1.5 text-[10px] font-semibold uppercase tracking-normal md:tracking-[0.16em] ${
                    isEnergy
                      ? "border-[rgba(247,208,163,0.16)] bg-[rgba(239,130,57,0.08)] text-[var(--accent-soft)]"
                      : "border-[rgba(89,89,201,0.16)] bg-[rgba(89,89,201,0.08)] text-[var(--accent-cool)]"
          ...
          <div className="relative order-1 h-[76px] overflow-hidden rounded-[0.85rem] border border-white/8 md:order-2 md:h-[188px] md:rounded-[1.1rem]">
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(13,6,37,0.06)_0%,rgba(13,6,37,0.18)_38%,rgba(13,6,37,0.84)_100%)]" />
            <span
              className={`absolute right-3 top-3 hidden h-10 w-10 items-center justify-center rounded-full border bg-black/35 text-[var(--text-strong)] shadow-[0_10px_28px_rgba(0,0,0,0.28)] backdrop-blur-md transition duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 md:inline-flex ${
                isEnergy
                  ? "border-[rgba(247,208,163,0.24)]"
                  : "border-[rgba(89,89,201,0.24)]"
              }`}
            >
...
export default function SplitHero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-white/8">
      ...
      />
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(13,6,37,0.82)_0%,rgba(13,6,37,0.9)_56%,rgba(13,6,37,0.96)_100%)]" />
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_14%_18%,rgba(239,130,57,0.16),transparent_28%),radial-gradient(circle_at_86%_18%,rgba(89,89,201,0.14),transparent_22%),radial-gradient(circle_at_52%_100%,rgba(239,130,57,0.08),transparent_28%)]" />
      <div className="pointer-events-none absolute -left-[12%] top-[8%] h-[30rem] w-[30rem] rounded-full border border-[rgba(89,89,201,0.1)] opacity-40 blur-[1px]" />
      <div className="pointer-events-none absolute -left-[8%] top-[2%] h-[24rem] w-[24rem] rotate-[18deg] rounded-full border border-[rgba(239,130,57,0.12)] opacity-55 blur-[1px]" />
      <div className="pointer-events-none absolute left-[18%] top-[12%] h-[32rem] w-[32rem] rotate-[28deg] rounded-full border border-[rgba(89,89,201,0.1)] opacity-35 blur-[1px]" />
